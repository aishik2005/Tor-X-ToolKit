...
async def homepage(request):
    return web.Response(
        text='<h1>🤗Tor X Toolkit server is Up and Running successfully🟢</h1>\n<h2>⚡See Tor X Toolkit on <a href="https://github.com/aishik2005\torxtoolkit">@GitHub</a></h2>\n<h2>🥲Join NL Bots <a href="https://t.me/nlbots">TG channel</a></h2>',
